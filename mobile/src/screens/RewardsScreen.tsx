...
import { getRewards, type PointsInfo } from "../api/account";
...
export default function RewardsScreen() {
  ...
  const load = useCallback(async () => {
    ...
    if (!result.success || !result.data) {
      setError(result.message || "Could not load rewards.");
      return;
    }
    setError(null);
    setInfo(result.data);
    ...
    >
      <FadeIn>
        ...
        <View style={styles.hero}>
          <Text style={styles.kicker}>REWARDS EARNED</Text>
        ...
        <Text style={s.section}>EARNING BREAKDOWN</Text>
        <View style={s.card}>
